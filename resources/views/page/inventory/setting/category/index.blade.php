...
@section('content')   
    ...
    <!-- /Page Body -->
    <!--Modal crate client-->
    @include('page.inventory.setting.category.form_save_category')
    <!--End Modal crate client-->
    <!--Modal edit client-->
    @include('page.inventory.setting.category.form_edit_category')
...
@section('scripts')
    ...
    <script src="{{ URL::asset('/scripts/inventory/setting/category/category.js')}}"></script>
@stop