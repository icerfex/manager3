                    ...
                    <div class="pull-left tableTools-container">
                        ...
                        <div class="btn-group">
                            ...
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu">
                                    <li>
                                        <a href="#" onclick="category.table('/warehouse/category/active','');return false;">Activos</a>
                                    </li>
                                    <li>
                                        <a href="#" onclick="category.table('/warehouse/category/delete','');return false;">Eliminados</a>
                                    </li>
                                    <li>
                                        <a href="#" onclick="category.table('/warehouse/category/all','');return false;">Todos</a>
                                    </li>
                                </ul>
                            </div><!-- /.btn-group -->
                        </div>
