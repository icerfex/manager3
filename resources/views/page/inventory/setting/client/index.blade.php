...
@section('content')   
                ...
                <div class="page-header">
                    <h1>
                        ...
                        <small>
                            ...
                            modulo donde puede crear cliente, editar, eliminar ver su kardex y ver la lista de clientes
                        </small>
                    </h1>
                </div><!-- /.page-header -->
                <div class="clearfix">
                    <div class="pull-left tableTools-container">
                        <div class="btn-group">
                            ...
                            <button type="button" id="kardex_client" class="btn btn-white btn-primary message-tooltip tooltip-info" title="Mostrara los productos mas comprados por el cliente selecionado"><i class="ace-icon fa fa-book bigger-130"></i></button>
                        </div>
                        <div class="btn-group">
                            <div class="btn-group">
                            ...
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu">
                                    <li>
                                        <a href="#" onclick="client.table('/inventory/setting/client/active','');return false;">Activos</a>
                                    </li>
                                    <li>
                                        <a href="#" onclick="client.table('/inventory/setting/client/delete','');return false;">Eliminados</a>
                                    </li>
                                    <li>
                                        <a href="#" onclick="client.table('/inventory/setting/client/all','');return false;">Todos</a>
                                    </li>
                                </ul>
                            </div><!-- /.btn-group -->
                        </div>
    ...
    <!-- /Page Body -->
    <!--Modal crate client-->
    @include('page.inventory.setting.client.form_save_client')
    <!--End Modal crate client-->
    <!--Modal edit client-->
    @include('page.inventory.setting.client.form_edit_client')
...
@section('scripts')
    ...
    <script src="{{ URL::asset('/scripts/inventory/setting/client/client.js')}}"></script>
