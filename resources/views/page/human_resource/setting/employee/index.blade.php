...
@section('content')   
    ...
    <!-- /Page Body -->
    <!--Modal crate client-->
    @include('page.human_resource.setting.employee.form_save_employee')
    <!--End Modal crate client-->
    <!--Modal edit client-->
    @include('page.human_resource.setting.employee.form_edit_employee')
...
@section('scripts')
    ...
    <script src="{{ URL::asset('/scripts/human_resource/setting/employee/employee.js')}}"></script>
@stop