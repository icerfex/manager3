<!--Modal crate client-->
<div class="modal modal-primary fade" tabindex="-1" role="dialog" aria-hidden="true" id="modal_form_save">
    <div class="modal-dialog">
        <div class="modal-content">
            <form onsubmit="return false;" action="{{URL::to('/inventory/setting/category')}}" id="save_form" method="post" >
