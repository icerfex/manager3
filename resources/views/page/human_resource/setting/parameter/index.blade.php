...
@section('content')   
    ...
    <!-- /Page Body -->
    <!--Modal crate client-->
    @include('page.human_resource.setting.parameter.form_save_parameter')
    <!--End Modal crate client-->
    <!--Modal edit client-->
    @include('page.human_resource.setting.parameter.form_edit_parameter')
...
@section('scripts')
    ...
    <script src="{{ URL::asset('/scripts/human_resource/setting/parameter/parameter.js')}}"></script>
@stop